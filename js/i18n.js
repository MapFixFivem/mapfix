...
const I18N = {
  fr: {
    ...
    'm.discord': 'Renseigne ton lien Discord dans js/config.js (discordInvite)', 'wh.on': 'Webhook activé sur ce navigateur', 'wh.off': 'Webhook désactivé', 'wh.bad': 'Adresse invalide : doit commencer par https://discord.com/api/webhooks/',
  ...
  en: {
    ...
    'm.discord': 'Set your Discord link in js/config.js (discordInvite)', 'wh.on': 'Webhook enabled on this browser', 'wh.off': 'Webhook disabled', 'wh.bad': 'Invalid address: must start with https://discord.com/api/webhooks/',
